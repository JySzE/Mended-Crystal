...
mended-crystal_obj      := $(rom_obj:.o=.o)
...
.SUFFIXES:
.PHONY: all mended-crystal crystal11 crystal_au crystal_debug crystal11_debug clean tidy compare tools
.SECONDEXPANSION:
.PRECIOUS:
.SECONDARY:

all: mended-crystal
mended-crystal:  mended-crystal.gbc
...
$(mended-crystal_obj):      RGBASMFLAGS +=
...
$(foreach obj, $(mended-crystal_obj), $(eval $(call DEP,$(obj),$(obj:.o=.asm))))
...
mended-crystal_opt      = -Cjv -t PM_CRYSTAL -i BYTE -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
