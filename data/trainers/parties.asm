...
JasmineGroup:
	...
	db 32, MAGNETON,  SUPERSONIC, THUNDER_WAVE, THUNDERBOLT, TRI_ATTACK
	db 34, FORRETRESS,  PIN_MISSILE, SELFDESTRUCT, ROLLOUT, RAPID_SPIN
	db 34, SKARMORY,  MUD_SLAP, SWIFT, FURY_ATTACK, STEEL_WING
...
PryceGroup:
	...
	db 39, DEWGONG,    HEADBUTT, ICY_WIND, AURORA_BEAM, RAIN_DANCE
	db 38, SNEASEL,    SCREECH, FAINT_ATTACK, ICY_WIND, FURY_SWIPES
