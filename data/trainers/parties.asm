...
WhitneyGroup:
	...
	db 19, TEDDIURSA,  SCRATCH, ATTRACT, LICK, FURY_SWIPES
...
Rival1Group:
	...
	db 42, ALAKAZAM,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 44, MEGANIUM,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 40, GENGAR,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 42, ALAKAZAM,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 44, TYPHLOSION, SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 40, GENGAR,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 42, ALAKAZAM,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 44, FERALIGATR, RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
ChampionGroup:
	...
	db 55, GYARADOS,   FLAIL, RAIN_DANCE, SURF, HYPER_BEAM
	db 56, KINGDRA,    DRAGON_RAGE, TWISTER, ICE_BEAM, HYDRO_PUMP
...
Rival2Group:
	...
	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 60, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 62, CROBAT,     TOXIC, BITE, CONFUSE_RAY, WING_ATTACK
	db 60, MAGNETON,   THUNDER, SONICBOOM, THUNDER_WAVE, SWIFT
	db 60, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 62, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 64, MEGANIUM,   GIGA_DRAIN, BODY_SLAM, LIGHT_SCREEN, SAFEGUARD
	db -1 ; end
	...
	db 60, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 62, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 64, TYPHLOSION, SMOKESCREEN, QUICK_ATTACK, FIRE_BLAST, SWIFT
	db -1 ; end
	...
	db 60, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 62, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 64, FERALIGATR, SURF, RAIN_DANCE, SLASH, SCREECH
	db -1 ; end
